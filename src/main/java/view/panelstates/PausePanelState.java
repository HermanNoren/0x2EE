...
import view.buttons.buttonactions.RestartGameButtonAction;
...
public class PausePanelState implements IPanelState {
    ...
    private void createButtons(){
        ...
        GameButton pauseButton2 = new GameButton("RESTART", 325, 300, new RestartGameButtonAction(EPanelState.INGAME, this, game));
